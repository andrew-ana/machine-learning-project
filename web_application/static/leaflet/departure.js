...
function createFeatures(airportData) {
    ...
    function restyle(feature) {
        var size1 = scaleSize(feature.properties.mean_arr_delay, 5, 40, -21.6, 448);
...
function createMap(airports) {
    ...
    legend.onAdd = function(map) {
        ...
        var labels = []
        var values = ["< 5 min", "6-19 min", "20-39 min", "40-59 min", "60+ min"];
    
        // Add legend title
        var legendInfo = "<h2>Average Flight Delay <hr> by Departure Airport</h2>"
